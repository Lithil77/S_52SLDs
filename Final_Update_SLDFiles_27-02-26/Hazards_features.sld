	...
	<sld:NamedLayer>
		...
		<sld:UserStyle>
			...
			<se:FeatureTypeStyle>
				...
				<!-- ===================================================== -->
				<!-- SHARED TEXT LABEL RULE (applies to all BCN points)    -->
				<!-- ===================================================== -->
				<se:Rule>
					<se:Name>BCN* Labels</se:Name>
					<ogc:Filter>
						<ogc:And>
				...
				<!-- ===================================================== -->
				<!-- SHARED TEXT LABEL RULE (applies to all BOY points)     -->
				<!-- ===================================================== -->
				<se:Rule>
					<se:Name>BOY* Labels</se:Name>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
								<ogc:PropertyName>obj</ogc:PropertyName>
				...
				<!-- ===================================================== -->
				<!-- SHARED TEXT LABEL RULE CONVYR - VERCLR Labels         -->
				<!-- ===================================================== -->
				<se:Rule>
					<se:Name>CONVYR - VERCLR Labels (L+A)</se:Name>
					<ogc:Filter>
						<ogc:And>
							<!-- Object must be CONVYR -->
							<ogc:PropertyIsEqualTo>
								<ogc:PropertyName>obj</ogc:PropertyName>
								<ogc:Literal>CONVYR</ogc:Literal>
							</ogc:PropertyIsEqualTo>
							<!-- Geometry must be line (1) or area (2) -->
							<ogc:Or>
								<ogc:PropertyIsEqualTo>
									<ogc:Function name="dimension">
										<ogc:PropertyName>geo</ogc:PropertyName>
				...
				<!-- ===================================================== -->
				<!-- SHARED TEXT LABEL RULE PIPOHD Labels                  -->
				<!-- ===================================================== -->
				<se:Rule>
					<se:Name>PIPOHD Labels</se:Name>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
								<ogc:PropertyName>obj</ogc:PropertyName>
				...
				<!-- Viewing group order:27020 and priority:8 -->
				<se:Rule>
					<se:Name>BCNSPP (P) - All cases</se:Name>
					<ogc:Filter>
						<ogc:PropertyIsEqualTo>
							<ogc:PropertyName>obj</ogc:PropertyName>
							<ogc:Literal>BCNSPP</ogc:Literal>

...
<sld:StyledLayerDescriptor version="1.1.0" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:ogc="http://www.opengis.net/ogc" xmlns:se="http://www.opengis.net/se" xmlns:sld="http://www.opengis.net/sld" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<sld:NamedLayer>
		<se:Name>DMPGRD</se:Name>
		<sld:UserStyle>
			<se:Name>DMPGRD</se:Name>
			<se:Description>
				<se:Abstract>A sea area where dredged material or other potentially more harmful material (for example: explosives or chemical waste) is deliberately deposited.</se:Abstract>
			</se:Description>
			<se:FeatureTypeStyle>
				<se:Rule>
				...
				<se:Rule>
					<se:Name>DMPGRD (A) - All cases | CATDPG5</se:Name>
					<ogc:Filter>
						<ogc:And>
							<ogc:PropertyIsEqualTo>
								<ogc:PropertyName>obj</ogc:PropertyName>
							...
							<ogc:PropertyIsEqualTo>
									  <ogc:Function name="attVal">
										...
										<ogc:Literal>CATDPG</ogc:Literal>
									  </ogc:Function>

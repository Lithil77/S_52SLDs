  ...
  <sld:NamedLayer>
    ...
    <sld:UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          <se:Name>BCN* (P) - BCNSHP=1</se:Name>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
		...
		<se:Rule>					
          <se:Name>BCN* (P) - BCNSHP=2</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
        ...
        <se:Rule>					
          <se:Name>BCN* (P) - BCNSHP=3</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
        ...
        <se:Rule>				
          <se:Name>BCN* (P) - BCNSHP=4</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
        ...
        <se:Rule>				
          <se:Name>BCN* (P) - BCNSHP=5</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>BCN* (P) - BCNSHP=7</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>BCN* (P) - BCNSHP=6</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
                <ogc:PropertyName>obj</ogc:PropertyName>
		...
		<se:Rule>
          <se:Name>BCNSPP/BCNLAT (P) - BCNSHP=6 and CONVIS=1</se:Name>					
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsLike wildCard="*" singleChar="." escapeChar="!">
					<ogc:PropertyName>obj</ogc:PropertyName>
